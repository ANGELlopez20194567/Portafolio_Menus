class QuoteCard extends HTMLElement {
  connectedCallback() {
    ...
    const features = (this.getAttribute('features') || 'Diseño responsive,Fácil de consultar,Personalizado a tu marca')
    ...
    root.innerHTML = `
      ...
      <section class="card" aria-label="Información y cotización del menú">
        ...
        <div class="body">
          ...
          <ul>${features.map(feature => `<li>${this.escape(feature)}</li>`).join('')}</ul>
